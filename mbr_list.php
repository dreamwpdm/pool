...
if(isset($_GET['dc'])){
	$dc=$_GET['dc'];
	$sql.=" WHERE deptcode='$dc' OR deptcode LIKE '%$dc%'";
}else{
	$dc="";
	$sql.=" WHERE deptcode IS NULL";
}
...
<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand"><span style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif; font-style: normal; font-weight: bold; font-size: 36px; text-align: center;">Department&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</span></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent1">
    ...
    <form class="form-inline my-2 my-lg-0">
	  <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="dc" id="dc" value="<?php echo($dc);?>">
...
<table table class="table table-hover table-bordered" align="right">
	...
	?>
    <tr>
      <td style="text-align: center"><a href="mbr_detail.php?deptcode=<?php echo($record[0]);?>"><span style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif; font-style: normal; font-weight: normal; font-size: 24px; text-align: center;"><?php echo($record[0]);?></span></a></td>

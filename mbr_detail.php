...
<table width="1200" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left" style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif; font-style: normal; font-weight: normal; font-size: 18px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo($deptcode);?></td>
    </tr>
    <tr>
      ...
      <td align="left" style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: normal;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo($deptname);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td>
		...
		<a height="75" colspan="2" align="center"><a href="mbr_list.php"> 
       <p>&nbsp;</p>
        <p><a href="mbr_list.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','pic/back1me.png',1)"><img src="pic/back2me.png" alt="" width="280" height="74" id="Image3" align = "middle">      
      </a>
    </tr><br />

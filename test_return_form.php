...
<table table class="table table-hover table-bordered" align="right">
 ...
 <?php
 $sql="SELECT equipments.mecode, equipments.ename, transections.tlend, DATE_ADD(transections.tlend, INTERVAL 1 DAY) AS deadline FROM equipments, transections WHERE equipments.mecode=transections.mecode AND transections.tstatus='1'";
//echo($sql);
 require('mysql/connect.php');
